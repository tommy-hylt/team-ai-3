...
- **Codex (OpenAI)**: `codex-gpt-5.6-luna`, `codex-gpt-5.6-terra`, `codex-gpt-5.6-sol` (still current as of 2026-09-09 — checked `~/.codex/models_cache.json`, no newer GPT family listed)
